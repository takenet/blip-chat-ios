...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Victor Balbo"
  # s.authors            = { "Victor Balbo" => "victorb@take.net" }
  # s.social_media_url   = "http://twitter.com/Victor Balbo"
  ...
  s.source = { :http  => "https://github.com/takenet/blip-chat-ios/raw/master/Releases/2.2.5-beta1.zip" }
  ...
  #s.source_files  = 'BlipChat/Framework/BlipChat.framework/**'
